    ...
    const sendMessage = () => {
        ...
        setTimeout(() => {
            ...
            if (containsHelloThere) {
                ...
                containsContact &&
                config.specialResponses.contactFormUrl &&
                config.specialResponses.contactFormUrl.trim() !== ""
            ) {
                const assistantMessage: Message = {
                    role: "assistant",
                    content: "",
                                            ...
                                            "" && (
                                                ...
                                                >
                                                    <iframe
                                                        ...
                                                        style={{
                                                            width: "100%",
                                                            height: `${config.specialResponses.contactFormHeight}px`,
                                                            border: "none",
                                                            borderRadius:
                                                                "12px",
                                                            backgroundColor:
